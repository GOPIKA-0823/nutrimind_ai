...
import { Eye, EyeOff, Heart, ArrowLeft, User, Shield } from 'lucide-react'
...
export default function AuthRegisterClient() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push(formData.role === 'doctor' ? '/doctor/dashboard' : '/dashboard')
    } catch (error) {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-gray-900">
            {formData.role === 'doctor' ? 'Join as a Doctor' : 'Create Account'}
          </h2>
          <p className="mt-2 text-gray-600">
            {formData.role === 'doctor'
              ? 'Start helping patients with AI-powered insights'
